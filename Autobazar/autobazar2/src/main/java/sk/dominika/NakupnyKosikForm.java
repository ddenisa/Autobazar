...
public class NakupnyKosikForm extends javax.swing.JFrame {
  ...
  private TableRowSorter autoRowSorter = new TableRowSorter(autoTableModel);
  
  private Auto auto;
  
  private List<Auto> zoznamAut = new ArrayList<Auto>();
  
  
    public NakupnyKosikForm(Auto auto,javax.swing.JFrame parent ) {
        initComponents();
    ...
    public void pridajVybratuKnihu(Auto auto){
        zoznamAut.add(auto);
        aktualizujZoznamAutVKosiku();
    }
    
    private void aktualizujZoznamAutVKosiku() {
        
        if(zoznamAut != null){
            for(int i = 0; i<zoznamAut.size(); i++){
                auto=zoznamAut.get(i);
                autoTableModel.dajAutoSTymtoIdDoKosika(auto.getID(), zoznamAut);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        tabZoznam.setModel(autoTableModel);
        tabZoznam.setRowSorter(autoRowSorter);
